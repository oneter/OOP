...
class Subscriber(BriefSubscriber):
    ...
    # Ãåòòåðû è ñåòòåðû ñ âàëèäàöèåé
    @property
    def inn(self):
        return self._inn
    ...
    def inn(self, value: str):
        if not value.isdigit() or len(value) != 10:
            raise ValueError("ÈÍÍ äîëæåí ñîäåðæàòü 10 öèôð.")
        self._inn = value
    ...
    def account(self, value: str):
        if not value.isdigit() or len(value) < 10:
            raise ValueError("Íîìåð ñ÷åòà äîëæåí ñîäåðæàòü íå ìåíåå 10 öèôð.")
        self._account = value

    # Ìåòîäû ñîçäàíèÿ îáúåêòîâ
    @classmethod
